text = 'The colors are here to help you distinguish the syntax of the song which is also written above the ' \
       ...
       'The goal is to determine a common threshold for syllable similarity for all of your data. ' \
       'You will adjust the threshold for each song until satisfied with the results. ' \
       'A summary of the thresholds used for all songs will be given at the end. ' \
       'Then, you will be given the chance to adjust the final threshold to be used in song analysis.' \
